...
export default function HomeSection() {
  ...
  return (
    <section className={styles.section}>
      ...
      {modalVideoVisible && <ModalVideo height="428" width="760" urlVideo="https://www.youtube.com/embed/dQH5nyK-dHU?si=7bvnVa_ik6et12zq" closeModalVideo={closeModalVideo} />}
    </section>
  );
}
